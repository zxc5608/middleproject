...
<div class="review1">
		...
		<div class="panel panel-warning" id="yellow">
			<div class="panel-heading" id="yyy">F&Q 등록</div>
		</div>
      ...
      <textarea class="form-control" id="reply" name="comments" placeholder="내용" ></textarea><br>
      <div class="row">
        <div class="form-write">
          <button class="button-w" type="submit">등록</button>
          <a href="<%=request.getContextPath() %>/admin/fNq.jsp" class="a"><button class="button-w">취소</button></a>
        </div>
      </div>
