...
<link rel="stylesheet" href="../css/modifyM.css">	
...
<hr>
	<h1 id="contw">수정 / 삭제</h1>

<div class="divv">
<div>
	<select name="category" class="sel" onchange="Category(this.value);">
		<option value="">카테고리</option>
		<option value="streaming">스트리밍</option>
		<option id="down" value="down">다운로드</option>
	</select>
</div>
...
<div class="btn-group">
  <button type="button" class="btn btn-primary" value="저장">저장</button>
