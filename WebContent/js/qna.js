...
var listPageServer = function(cpage){
	$.ajax({
		...
		success : function(res){
			...
			code += '  <h2 class="title">Q/A</h2>                                                                                 ';
			code += '  <a href="../qna/QnaWrite.jsp"> <button type="button" idx="20" name="" class="btn btn-warning action1">질문하기</button></a>    ';
			...
			code += '                                                                                                             ';
			code += '          <p class="p2">                                                                                     ';
			code += '             <button type="button" onclick="buttup()" idx="' + v.qno + '" name="modify" class="action">수정하기</button>          ';
			code += '             <button type="button"onclick="buttdel()" idx="' + v.qno + '" name="delete" class="action">삭제하기</button>          ';
			code += '          </p>                                                                                               ';
			code += '          <p  class="p1">                                                                                    ';
			code += '                      질문 번호: ' + v.qno + '   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;                                        ';
			code += '                      작성자     : ' + v.writer + '   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;                              ';
...
var boardUpdateServer = function(but){	// 수정 모달창에서
	 
	 $.ajax({
		url : '/MiddleProject/qnaUpdate.do',
		type : 'post',
